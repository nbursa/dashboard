<template>
  <div class="flex flex-col items-center justify-start w-full h-full p-2 md:p-4 bg-white/20 rounded-lg shadow-lg">
    <div class="flex items-center justify-between w-full mb-2">
      <button @click="prevMonth" class="text-xs lg:text-sm font-bold">&lt;</button>
      <span class="text-base md:text-lg font-semibold">{{ monthYear }}</span>
      <button @click="nextMonth" class="text-xs lg:text-sm font-bold">&gt;</button>
    </div>
